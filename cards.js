...
const allPosts = [
  {
    img: "./assets/test_img.webp",
    title: "BROKEN CONCRETE - I'm falling apart.",
    date: "01/26/26",
    newPost: true,
    url: "broken_concrete",
  },
  {
    img: "./assets/test_img2.jpg",
    title: "BROKEN CONCRETE - I'm falling apart.",
    date: "01/26/26",
    url: "broken_concrete",
  },
  {
    img: "./assets/test_img3.webp",
    title: "BROKEN CONCRETE - I'm falling apart.",
    date: "01/26/26",
    url: "broken_concrete",
  },
...
function loadPosts() {
  for (
    let i = loadedCount;
    i < loadedCount + loadStep && i < allPosts.length;
    i++
  ) {
